    ...
    <footer className="bg-black text-gray-300 border-t border-[#d4af37]/20">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <Link href="/">
            <Image src="/logo-axa.svg" alt="AXA Professional" width={180} height={40} className="h-16 w-40 object-cover drop-shadow-md hover:scale-105 transition-transform duration-300" />
            </Link>
